...
ThemeData lightTheme = ThemeData(
  ...
  primaryColor: Modular.get<ColorPalettes>().darkAccent,
  ...
  appBarTheme: AppBarTheme(
    textTheme:
    _myTextTheme.apply(bodyColor: Modular.get<ColorPalettes>().lightBG),
    elevation: 0,
  ),
...
ThemeData darkTheme = ThemeData(
  ...
  bottomNavigationBarTheme: BottomNavigationBarThemeData(
    ...
    selectedIconTheme: IconThemeData(
      color: Modular.get<ColorPalettes>().darkAccent
    )
  ),
  buttonTheme: ButtonThemeData(
    buttonColor: Modular.get<ColorPalettes>().darkAccent,
